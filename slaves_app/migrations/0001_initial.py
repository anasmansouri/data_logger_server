# Generated by Django 2.2.15 on 2020-08-04 19:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sensor_value_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='slaves_app.SensorValueType')),
                ('setting', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='slaves_app.Setting')),
            ],
        ),
    ]
